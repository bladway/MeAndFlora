...
class _RestUserClient implements RestUserClient {
  ...
  @override
  Future<Account> createAccountByAdmin({required Account account}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UserInfoDtoList> getAccounts(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<UserInfoDtoList>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UserInfoDtoList.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<StringDto> deleteUser({required StringDto string}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(string.toJson());
    final _result = await _dio
