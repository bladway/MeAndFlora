...
@RoutePage()
class NavBarAuthUserScreen extends StatelessWidget {
    ...
    return WillPopScope(
      ...
      child: AutoTabsRouter(
        routes: [
          ...
          const HistoryRoute(),
          const TrackRoute(),
          AccountRoute(account: const Account(
              name: "Name",
              surname: "Surname",
              email: "email",
              phone: "phone",
            ...
            bottomNavigationBar: ClipRRect(
              ...
              child: NavigationBar(
                ...
                destinations: const [
                  ...
                  NavBarElement(icon: Iconsax.book_saved_copy),
                  NavBarElement(icon: Iconsax.location_copy),
