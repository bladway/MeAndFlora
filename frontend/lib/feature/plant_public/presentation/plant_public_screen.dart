...
import '../../../core/presentation/widgets/background.dart';
    ...
    return MultiBlocProvider(
        providers: [
          BlocProvider<PlantTrackBloc>(
            lazy: false,
            create: (context) =>
                PlantTrackBloc()..add(PlantTrackListRequested()),
          ),
          BlocProvider<PlantBloc>(
              lazy: false, create: (context) => PlantBloc()),
        ],
        child: Scaffold(
          ...
          body: BlocBuilder<PlantTrackBloc, PlantTrackState>(builder: (context, state) {
